...
public class accessories_bill extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        total_amount_toPay = getIntent().getStringExtra("total");
...
//        Toast.makeText(this, totalAmount, Toast.LENGTH_SHORT).show();
    ...
    void payUsingUpi(  String name,String upiId, String note, String amount) {
        ...
        Toast.makeText(this, "Amount = " + total_amount_toPay, Toast.LENGTH_SHORT).show();
//        upiPayIntent.setData(Uri.parse(merchantUPILink + "&am=" + total_amount_toPay));
